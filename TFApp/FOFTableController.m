...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    if (m_isFOFTableEmpty == TRUE) {
        ...
        if (cell == nil) {
            cell = [[UITableViewCell alloc] initWithStyle:[self cellStyle] reuseIdentifier:cellId] ;
        }
        ...
        if (cell == nil) {
            ...
            if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
                topLevelObjects = [[NSBundle mainBundle]loadNibNamed:@"FOFTableCell_iPad" owner:self options:nil];
            } else {
                topLevelObjects = [[NSBundle mainBundle]loadNibNamed:@"FOFTableCell" owner:self options:nil];            
            }
