...
- (id)initWithFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        objs = [[NSBundle mainBundle] loadNibNamed:@"FOFTableCell_iPad" owner:nil options:nil];        //device is an iPad.
    } else {
...
- (void) increaseCommentsCounter{
    NSString *newCount = [[NSString alloc] initWithFormat:@"%d", [commentsCountLabel.text intValue] + 1] ;
